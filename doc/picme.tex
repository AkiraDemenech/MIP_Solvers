...
\fi
	...
	\section{Experimentos computacionais}
		...
		\begin{enumerate}
			\item \texttt{sobolev} \cite{sobolev}:	
			\item \texttt{beasley} \cite{beasley}:
			\item \texttt{holmberg} \cite{holmberg}:				
			\item \texttt{mess} \cite{mess}:	
		\end{enumerate} 
		...
		Cada instância de \texttt{sobolev}, \texttt{beasley} e \texttt{holmberg} foi resolvida três vezes, com os limites de tempo de 2, 5 e 10 minutos.
